        ...
        <div>
          <div>
            {userData.spotify_profile && userData.spotify_refresh_token ? (
              <Card width="100%">
                <User
                  src={userData.spotify_profile.images[0].url}
                  name={userData.spotify_profile.display_name}
                >
                  {userData.phone}
                  <User.Link
                    href={userData.spotify_profile.external_urls.spotify}
                  >
                    {userData.spotify_profile.uri}
                  </User.Link>
                </User>
                <Button
                  size="mini"
                ...
                <Collapse title="Your song entries">
                  {userEntries.map((entry) => (
                    <div style={{ display: "flex", flexWrap: "wrap" }}>
                      <div style={{ flex: "50%" }}>
                        <Image
                          src={entry.songData.album.images[1].url}
                          width={70}
                          height={70}
                        />
                      </div>
